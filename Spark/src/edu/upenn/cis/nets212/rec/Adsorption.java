...
public class Adsorption {
	...
	public static void main(String[] args) {
		final Adsorption cr = new Adsorption();
		try {
			cr.initialize();
	...
	static public class Article {
		...
		public String link;
		public String date;
		public Article (String category, String headline, String link, String date) {
	...
	static public class Label {
		...
		public Label(User user, double weight) {
			this.user = user;
			this.weight = weight;
		}
		...
		public boolean equals(Object other) {
			...
			Label otherL = (Label) other;
			return otherL.user.equals(this.user);
		}
